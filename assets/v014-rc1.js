/* Rota 27 v0.14 RC.1 — camada mínima de candidata
 * Mantém a lógica consolidada do DEV.3 e corrige metadados/backup da candidata.
 */
(function () {
  'use strict';

  const RC_VERSION = '0.14-rc.1';
  ...
  function downloadRcBackup() {
    try {
      ...
      console.error('[Rota27 RC.1] Falha ao gerar backup:', err);
  ...
  function applyRcIdentity() {
    ...
    if (badge) badge.textContent = 'v0.14 RC.1';
    document.title = 'Rota 27 Bodega • Comandas v0.14 RC.1';
