/* Rota 27 v0.25.21 — Histórico Ontem, leitura de fechamentos, campanha de aniversários e baseline operacional */
(function(){
  'use strict';
  const VERSION='0.25.21';
  function updateIdentity(){
    document.title='Rota 27 Bodega • Comandas v0.25.21';
    const meta=document.querySelector('meta[name="rota27-release-version"]');if(meta)meta.content=VERSION;
    let style=document.getElementById('v02521ReleaseIdentity');
    if(!style){style=document.createElement('style');style.id='v02521ReleaseIdentity';style.textContent='#v14VersionBadge::after{content:"v0.25.21"!important}';document.head.appendChild(style);}
  }
  function updateHelpIdentity(){const overlay=document.getElementById('r27HelpOverlay');const footer=overlay?.querySelector('.r27-help-footer span');if(footer)footer.textContent='Ajuda v7.0 • Rota 27 v0.25.21';}
  ...
  function start(){
    ...
    window.Rota27V02521Release=api;window.Rota27V02520Release=api;window.Rota27V02519Release=api;window.Rota27V02518Release=api;window.Rota27V02517Release=api;window.Rota27V02516Release=api;window.Rota27V02515Release=api;
    console.info('[Rota27] v0.25.21 — Histórico Ontem, leitura de fechamentos, campanha de aniversários e baseline operacional carregados.');
  }
