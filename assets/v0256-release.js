/* Rota 27 v0.25.22-r4 — refinamento dos Fechamentos, Histórico Ontem e baseline operacional */
(function(){
  'use strict';
  ...
  function loadReleaseAssets(){
    ...
    loadCss('v02522ClosurePolishCss','./assets/v02522-closure-polish.css?v=02522r4');
    const scripts=[
      ...
      ['v02522R3ClosureRenderJs','./assets/v02522r3-closure-render.js?v=02522r4']
    ];
  ...
  function start(){
    ...
    console.info('[Rota27] v0.25.22-r4 — refinamento resiliente dos Fechamentos e Histórico Ontem carregados.');
  }
