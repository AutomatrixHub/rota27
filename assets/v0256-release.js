/* Rota 27 v0.25.18 — identidade operacional, aniversário no cadastro rápido e reparo histórico */
(function(){
  'use strict';
  const VERSION='0.25.18';
  function updateIdentity(){
    document.title='Rota 27 Bodega • Comandas v0.25.18';
    const meta=document.querySelector('meta[name="rota27-release-version"]');if(meta)meta.content=VERSION;
    let style=document.getElementById('v02518ReleaseIdentity');
    if(!style){style=document.createElement('style');style.id='v02518ReleaseIdentity';style.textContent='#v14VersionBadge::after{content:"v0.25.18"!important}';document.head.appendChild(style);}
  }
  function updateHelpIdentity(){const overlay=document.getElementById('r27HelpOverlay');const footer=overlay?.querySelector('.r27-help-footer span');if(footer)footer.textContent='Ajuda v6.9 • Rota 27 v0.25.18';}
  ...
  function start(){
    ...
    window.Rota27V02518Release=api;window.Rota27V02517Release=api;window.Rota27V02516Release=api;window.Rota27V02515Release=api;
    console.info('[Rota27] v0.25.18 — cadastro rápido com nascimento, reparo histórico e data operacional carregados.');
  }
