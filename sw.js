const CACHE_NAME = 'rota27-comandas-v0.25.89-r1';
const APP_SHELL = [
...
self.addEventListener('message',event=>{
  ...
  if(type==='ROTA27_GET_RELEASE')event.ports?.[0]?.postMessage({version:'0.25.89',cacheName:CACHE_NAME});
});
