const CACHE_NAME = 'rota27-comandas-v0.25.34-r1';
const APP_SHELL = [
  ...
  './assets/v02533-menu-header-polish.css','./assets/v02533-menu-header-polish.js','./assets/v02534-menu-actions-polish.css','./assets/v02534-menu-actions-polish.js',
