const CACHE_NAME = 'rota27-comandas-v0.25.25-r1';
const APP_SHELL = [
  ...
  './assets/v02522-closure-polish.css','./assets/v02522r3-closure-render.js','./assets/v02524-history-finish.css','./assets/v02525-panel-finish.css',
