const CACHE_NAME = 'rota27-comandas-v0.25.0-r2';
const APP_SHELL = [
  ...
  './assets/v025-relationship.css','./assets/v025-relationship-r2.css','./assets/v025-relationship.js','./assets/v025-release-identity.css',
