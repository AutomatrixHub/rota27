const CACHE_NAME = 'rota27-comandas-v0.25.92-r1';
const RELEASE_VERSION = '0.25.92';
const APP_SHELL = [
...
const ROADMAP_SUFFIX = `\n;(function(){
  function bootV02590(){
    try{
      ...
      var footer=document.querySelector('#r27HelpOverlay .r27-help-footer span');if(footer)footer.textContent='Ajuda v10.0 • Rota 27 v${RELEASE_VERSION}';
